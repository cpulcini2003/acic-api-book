...
```
tanzu apps workload create acic-api-book -f config/workload.yaml \
  --local-path . \
  --source-image <REPOSITORY-PREFIX>/acic-api-book-source \
  --type web
```
...
```
tanzu apps workload get acic-api-book
```
